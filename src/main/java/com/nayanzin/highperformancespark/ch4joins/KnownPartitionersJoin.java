...
spark-submit \
    --master    local[4] \
    --name      KnownPartitionersJoin \
    --class     com.nayanzin.highperformancespark.ch4joins.KnownPartitionersJoin \
    build/libs/spark-java-1.0-SNAPSHOT.jar \
    $INPUT_ADDRESS \
    $INPUT_SCORES \
    $OUTPUT
 */
public class KnownPartitionersJoin implements Serializable {
